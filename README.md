...
- 🔌 7 secret manager plugins (1Password, Infisical, AWS, Azure, GCP, Bitwarden, Psono)
...
| [@varlock/psono-plugin](packages/plugins/psono) | [![npm version](https://img.shields.io/npm/v/@varlock/psono-plugin.svg)](https://npmjs.com/package/@varlock/psono-plugin) |
